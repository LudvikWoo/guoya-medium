...
package com.guoyasoft.bean.login.response;
...
public class Response implements java.io.Serializable {
    ...
    public Response() {
        super();
    } //-- com.guoyasoft.bean.login.response.Response()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.login.response.Response unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.login.response.Response) Unmarshaller.unmarshal(com.guoyasoft.bean.login.response.Response.class, reader);
    } //-- com.guoyasoft.bean.login.response.Response unmarshal(java.io.Reader) 
